...
//    Diceware dw = new Diceware(bundle);
    ...
    System.out.println(Arrays.toString(passphrase));
      ...
      System.out.println("Not enough words in the wordlist.");
    } catch (IllegalArgumentException ex) {
      // TODO Assume we've logged this or done something else with ex.
      throw ex;
//      System.out.println("You can't have a negative passphrase!!!");
    } finally {
